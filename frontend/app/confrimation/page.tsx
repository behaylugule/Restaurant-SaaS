            ...
            <div className="w-full lg:w-3/4 xl:w-1/2 lg:bg-white flex justify-between">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-4 mb-8 py-12 px-10 relative">
                    ...
                    <div className="flex flex-col items-center">
                        <h3 className="font-montserrat font-medium text-[23px] text-gray-900 text-center dark:text-white my-8 ]">Password Reset Link Sent</h3>
                        <span className="w-full text-center mb-8 font-normal text-[14px] text-gray-700 dark:text-gray-300">Please Check your <span className='font-medium text-[16px]'>{searchParams.get('email')}</span> Address  </span>
