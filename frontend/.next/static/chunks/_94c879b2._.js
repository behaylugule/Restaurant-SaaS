...
function Page() {
    ...
    const generateOrderReport = ()=>{
        var _params_orderId;
        if (!((_params_orderId = params.orderId) === null || _params_orderId === void 0 ? void 0 : _params_orderId.toLocaleString())) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reportService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reportsService"].generateOrderDetail(params.orderId.toLocaleString()).then((res)=>{
...
//# sourceMappingURL=_94c879b2._.js.map