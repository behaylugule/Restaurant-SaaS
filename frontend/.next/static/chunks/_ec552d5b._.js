...
function Page() {
    ...
    const getUserData = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].getUsers().then((res)=>{
            console.log(res);
...
_s(Page, "gSZWH+kJwAdt1i4JjT8ITi7XAO4=", false, function() {
    return [
...
//# sourceMappingURL=_ec552d5b._.js.map