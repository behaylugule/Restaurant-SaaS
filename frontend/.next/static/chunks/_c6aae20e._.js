...
async function getOrderItems(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/order-items/', {
        params: {
            ...data
        }
    });
...
function Page() {
    ...
    const handleSubmitRateModal = ()=>{
        const data = {
            rate: starValue,
            comment: comment,
            menu: orderItemDetail === null || orderItemDetail === void 0 ? void 0 : orderItemDetail.menu,
            shop: orderDetail === null || orderDetail === void 0 ? void 0 : orderDetail.shop
        };
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Page, "DpcV117cmO4QtIdELHWk362Q/QE=", false, function() {
    return [
...
//# sourceMappingURL=_c6aae20e._.js.map