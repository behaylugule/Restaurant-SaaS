...
function Register() {
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].registerUser(data).then((res)=>{
            setIsLoading(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Uder has registered successfully");
            router.push('/login');
        }).catch((error)=>{
            setIsLoading(false);
        });
...
_s(Register, "fwmZF5ijbx4q2WwkkpK0sQwRVAs=", false, function() {
    return [
