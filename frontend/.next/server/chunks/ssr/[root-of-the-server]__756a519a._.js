...
"[project]/app/forgetpassword/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Register() {
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].forgetPassword(data.email).then((res)=>{
            setIsLoading(false);
            router.push(`/confrimation/?email=${getValues('email')}`);
        }).catch((err)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(err.response.data.message);
            setIsLoading(false);
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__756a519a._.js.map