...
"[project]/hook/usePagination.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function usePagination() {
    ...
    const [totalCount, setTotalCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(0);
    // State for the number of items per page, initialized to 2
    const [pageSize, setPageSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(page_sizes[0] || 10); // Default to the first page size or 10
    // Calculate total pages dynamically
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(apiBaseUrl + '/token/refresh');
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].error(error.response?.data?.message || 'An error occurred');
    return Promise.reject(error);
});
const __TURBOPACK__default__export__ = api;
}),
"[project]/lib/services/dinningTableService.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getDiningTables(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get('/dining-tables/', {
        params: {
            ...data
        }
    });
...
async function getDiningTable(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`/dining-tables/${id}/`);
}
async function addDiningTables(payload) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post('/dining-tables/', payload);
}
async function deleteDiningTable(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].delete(`/dining-tables/${id}/`);
}
async function updateDiningTable(id, payload) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].put(`/dining-tables/${id}/`, payload);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hook$2f$usePagination$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hook/usePagination.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$dinningTableService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/dinningTableService.ts [app-rsc] (ecmascript)");
...
function DiningTables() {
    ...
    const [diningTableData, setDiningTableData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [actionType, setActionType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("add");
    const [diningTableDetail, setdiningTableDetail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])();
    const pagination = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hook$2f$usePagination$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["usePagination"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!isAuthenticated) router.push("/login");
    }, []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user.role !== __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["USER_ROLE"].SHOP_ADMIN) router.push("/");
    }, [
        user.id
    ]);
    const getDiningTables = ()=>{
        setIsLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$dinningTableService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diningTableService"].getDiningTables({
    ...
    const handleDeleteDiningTable = async (id)=>{
        if (!id) return;
        setIsLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$dinningTableService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diningTableService"].deleteDiningTable(id).then((res)=>{
            setIsLoading(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2457931d._.js.map