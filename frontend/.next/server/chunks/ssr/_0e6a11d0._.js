...
;
;
function FilterBar({ config, onFilterChange }) {
...
function Page() {
    ...
    const generateReport = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$reportService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reportsService"].generateOrderReport().then((res)=>{
            console.log(res);
...
//# sourceMappingURL=_0e6a11d0._.js.map