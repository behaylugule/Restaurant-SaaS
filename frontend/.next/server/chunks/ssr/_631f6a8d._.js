...
async function getKichenDisplay(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/kitchen-display/', {
        params: {
            ...data
        }
    });
...
{
const e = new Error("Could not parse module '[project]/components/admins/display/DisplayCard.tsx'\n\nExpected '</', got '}'");
...
//# sourceMappingURL=_631f6a8d._.js.map